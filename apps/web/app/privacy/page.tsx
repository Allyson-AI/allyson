export const metadata = {
  title: "Privacy Policy - Allyson - AI Web Agent",
  description:
  ...
  return (
    <>
      <main className="flex-1 p-4 flex-col items-center justify-center mx-auto pb-6  bg-dot-black/[0.1]">
        ...
        <ul>
          ...
          <li>
            <p className="mb-2">
              ...
              in this Agreement) refers to Allyson, Inc., 8 The Green, Suite A,
              Dover, DE 19901.
            </p>
          </li>
          <li>
        ...
        <p className="mb-2">
          We would like to clarify that our application does not use data
          obtained through Google Workspace APIs to develop, improve, or train
          any generalized AI and/or machine learning (ML) models. We ensure that
          user data from Google Workspace is handled in compliance with all
          applicable privacy and data protection regulations, and it is not used
          for any non-personalized AI/ML model development or improvement.
        </p>
