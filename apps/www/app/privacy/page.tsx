...
export const metadata = {
  title: "Privacy Policy - Allyson AI Executive Assistant",
  description:
  ...
  return (
    <>
      ...
      <main className="flex-1 max-w-[85rem] px-8 flex-col items-center justify-center mx-auto pt-6 md:pt-12 pb-6  bg-dot-black/[0.1]">
          <h1 className="mb-2 mt-20 text-3xl font-bold"> Privacy Policy</h1>
          <p className="mb-2 font-bold">Last updated: September 28, 2024</p>
          <p className="mb-2">
          ...
          <ul>
            ...
            <li>
              <p className="mb-2">
                <strong>Application</strong> refers to Allyson, the software
            ...
            <li>
              <p className="mb-2">
                ...
                in this Agreement) refers to Allyson, Inc., 8 The Green,
                Suite A, Dover, DE 19901.
              </p>
            </li>
            <li>
              <p className="mb-2">
            ...
            <li>
              <p className="mb-2">
                <strong>Website</strong> refers to Allyson, accessible from{" "}
                <a
                  href="https://allyson.ai"
          ...
          <h4 className="mb-2 text-lg font-bold">Personal Data</h4>
          <p className="mb-2">
          ...
          <h4 className="mb-2 text-lg font-bold">Usage Data</h4>
          <p className="mb-2">
          ...
          <h3 className="mb-2 text-xl font-bold">Use of Your Personal Data</h3>
          <p className="mb-2">
          ...
          <h3 className="mb-2 text-xl font-bold">Delete Your Personal Data</h3>
          <p className="mb-2">
          ...
          <h2 className="mb-2 text-2xl font-bold">Use of Google Workspace APIs and AI/ML Model Training          </h2>
          <p className="mb-2">
          We would like to clarify that our application does not use data obtained through Google Workspace APIs to develop, improve, or train any generalized AI and/or machine learning (ML) models. We ensure that user data from Google Workspace is handled in compliance with all applicable privacy and data protection regulations, and it is not used for any non-personalized AI/ML model development or improvement.
          </p>
          ...
          <ul>
            <li>By email: info@allyson.ai</li>
          </ul>
      </main>
      <Footer />
    </>
