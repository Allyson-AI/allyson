import Footer from "@allyson/ui/layout/footer";
import Header from "@allyson/ui/layout/header";
import { Card } from "@allyson/ui/card";

export const metadata = {
  title: "Terms & Conditions - Allyson AI Executive Assistant",
  description:
    "Allyson enhances operations and accelerates growth by deploying intelligent AI agents—anywhere, anytime.",
  openGraph: {
    title: "Terms & Conditions - Allyson AI Executive Assistant",
    siteName: "Allyson",
    description:
      "Allyson enhances operations and accelerates growth by deploying intelligent AI agents—anywhere, anytime.",
    url: "https://allyson.ai/terms",
...
export default async function Terms() {
  return (
    <>
      <Header />
      <main className="flex-1 max-w-[85rem] px-8 flex-col items-center justify-center mx-auto pt-6 md:pt-12 pb-6  bg-dot-black/[0.1]">

          <h1 className="mb-2 mt-20 text-3xl font-bold">Terms and Conditions</h1>
          <p className="mb-2">
          ...
          <p className="mb-2">
            ...
            conditions. Do not continue to use Allyson if you do not agree to
          ...
          <p className="mb-2">
            We employ the use of cookies. By accessing Allyson, you agreed to
            use cookies in agreement with the Allyson, Inc.'s Privacy Policy.{" "}
          </p>
          ...
          <p className="mb-2">
            Unless otherwise stated, Allyson, Inc. and/or its licensors own
            the intellectual property rights for all material on Allyson. All
            intellectual property rights are reserved. You may access this from
            Allyson for your own personal use subjected to restrictions set
            in these terms and conditions.
          </p>

          <p className="mb-2">You must not:</p>
          <ul>
            <li>Republish material from Allyson</li>
            <li>Sell, rent or sub-license material from Allyson</li>
            <li>Reproduce, duplicate or copy material from Allyson</li>
            <li>Redistribute content from Allyson</li>
          </ul>
          ...
          <p className="mb-2">
            ...
            Allyson, Inc. does not filter, edit, publish or review Comments
            prior to their presence on the website. Comments do not reflect the
            views and opinions of Allyson, Inc.,its agents and/or affiliates.
            ...
            Allyson, Inc. shall not be liable for the Comments or for any
          ...
          <p className="mb-2">
            Allyson, Inc. reserves the right to monitor all Comments and to
          ...
          <p className="mb-2">
            ...
            visibility of the hyperlink compensates the absence of Allyson,
          ...
          <p className="mb-2">
            ...
            sending an e-mail to Allyson, Inc.. Please include your name,
          ...
          <p className="mb-2">
            No use of Allyson, Inc.'s logo or other artwork will be allowed
