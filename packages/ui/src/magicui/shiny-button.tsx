...
const ShinyButton = ({ text = "shiny-button" }) => {
  return (
    (<motion.button
      {...animationProps}
      className="relative rounded-lg px-6 py-4 mt-4 font-medium backdrop-blur-xl transition-[box-shadow] duration-300 ease-in-out hover:shadow dark:bg-[radial-gradient(circle_at_50%_0%,hsl(var(--primary)/10%)_0%,transparent_60%)] dark:hover:shadow-[0_0_20px_hsl(var(--primary)/10%)]">
      <span
